<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LessonSettings.aspx.cs" Inherits="_LessonSettings" %>
                ...
                <div id="LessonSettingsLeftPanel">
                    <div id="uploadFiles">
                        ...
                        <asp:Panel ID="deleteFalert" runat="server" Visible="false">
                            <div id="DeleteFdiv">
                                <img id="DeleteImage" class="deleteimagelesson" src="generatorElements/deletobject.png" />
                                ...
                                <asp:Button ID="deleteApprove" class="Lessondeletebtn" runat="server" Text="בטוח/ה!, כן - מחק" OnClick="deleteApprove_Click" />
                                <asp:Button ID="deleteCancel" class="Lessondeletebtn" runat="server" Text="התבלבלתי! , לא - חזור" OnClick="deleteCancel_Click" />
                            </div>
                        </asp:Panel>
                    </div>
                    <div id="settingsBtns">
