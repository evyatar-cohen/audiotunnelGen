<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseSettings.aspx.cs" Inherits="_CourseSettings" %>
        ...
        <form id="form1" runat="server">
            ...
            <div id="SettingsPage">
                ...
                <div id="SettingsLeftPanel">
                    ...
                    <div id="settingsBtns">
                        <asp:Button ID="backToDefualt" runat="server" Text="חזור" value="" OnClick="backToDefualt_Click" />
                        <asp:Button ID="UpadteCourse"  runat="server" Text="שמירה" value="" OnClick="saveCourse_Click" />
                    </div>
                </div>
